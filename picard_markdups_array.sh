...
#set SAMPLE_LIST
SAMPLE_LIST="/scratch/pawsey1142/gracefang/WPM_project/WPM_population_genetics/sample_list_markdups"
...
OUTDIR="/scratch/pawsey1142/gracefang/WPM_project/WPM_population_genetics/2b.MarkDuplicates"
OUTPUT="${OUTDIR}/${SAMPLE}.markdup.bam"
METRIX="/scratch/pawsey1142/gracefang/WPM_project/WPM_population_genetics/2b.MarkDuplicates/$SAMPLE.marked_dup_metrics.txt"
