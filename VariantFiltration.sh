...
GenotypeGVCF="/scratch/pawsey1142/gracefang/WPM_project/WPM_population_genetics/7b.GenotypeGVCFs/genotypeGVCF.v3.vcf.gz"
OUTPUT_FILE="/scratch/pawsey1142/gracefang/WPM_project/WPM_population_genetics/8b.VariantFiltration/genotypeGVCF_filtered_all.vcf.gz"
